...
GMLFN(log10); GMLFN(max); GMLFN(min); GMLFN(point_direction); GMLFN(point_distance); GMLFN(point_in_circle);
...
GMLFN(base64_decode); GMLFN(base64_encode); GMLFN(chr); GMLFN(ord); GMLFN(real); GMLFN(string); GMLFN(__string__); GMLFN(string_byte_length);
GMLFN(string_char_at); GMLFN(string_concat); GMLFN(string_concat_ext); GMLFN(string_copy);
GMLFN(string_delete); GMLFN(string_digits); GMLFN(string_ext); GMLFN(string_foreach);
...
GMLFN(is_struct); GMLFN(instanceof); GMLFN(is_instanceof); GMLFN(is_method); GMLFN(typeof_fn); GMLFN(bool_fn);
GMLFN(variable_clone); GMLFN(variable_global_exists); GMLFN(variable_instance_exists); GMLFN(variable_struct_set);
GMLFN(variable_struct_get); GMLFN(variable_struct_exists);
GMLFN(struct_set); GMLFN(struct_get); GMLFN(struct_exists); GMLFN(struct_remove);

GMLFN(array_create); GMLFN(array_length); GMLFN(array_length_1d); GMLFN(array_push);
GMLFN(array_concat); GMLFN(array_contains); GMLFN(array_equals); GMLFN(array_filter);
GMLFN(array_foreach); GMLFN(array_get_index); GMLFN(array_map_ext); GMLFN(object_exists);
GMLFN(array_last); GMLFN(array_pop); GMLFN(array_resize); GMLFN(array_copy); GMLFN(array_delete); GMLFN(array_insert);
...
GMLFN(gpu_set_blendenable); GMLFN(gpu_set_blendmode); GMLFN(gpu_set_depth); GMLFN(gpu_set_fog); GMLFN(gpu_set_texfilter);
...
GMLFN(application_get_position); GMLFN(display_get_width); GMLFN(display_get_height); GMLFN(display_get_gui_width);
...
GMLFN(keyboard_virtual_show); GMLFN(keyboard_virtual_hide); GMLFN(keyboard_virtual_status);
...
GMLFN(gamepad_enumerate); GMLFN(gamepad_get_description); GMLFN(gamepad_get_device_count); GMLFN(gamepad_get_guid);
GMLFN(gamepad_is_connected); GMLFN(gamepad_test_mapping); GMLFN(gamepad_set_vibration);
GMLFN(gamepad_set_axis_deadzone);
GMLFN(ps5_gamepad_set_trigger_effect_feedback); GMLFN(ps5_gamepad_set_trigger_effect_off);
GMLFN(ps5_gamepad_set_trigger_effect_vibration); GMLFN(ps5_gamepad_set_trigger_effect_weapon);
GMLFN(gamepad_button_check_released); GMLFN(gamepad_button_count); GMLFN(gamepad_button_value);
GMLFN(gamepad_hat_count); GMLFN(gamepad_axis_count);
...
GMLFN(audio_is_paused); GMLFN(audio_sound_get_asset); GMLFN(audio_sound_get_gain); GMLFN(audio_sound_get_pitch);
...
GMLFN(time_source_create); GMLFN(time_source_destroy); GMLFN(time_source_exists);
GMLFN(time_source_start); GMLFN(time_source_stop); GMLFN(time_source_pause);
GMLFN(time_source_resume); GMLFN(time_source_reset); GMLFN(time_source_reconfigure);
GMLFN(time_source_get_period); GMLFN(time_source_get_reps_completed);
GMLFN(time_source_get_reps_remaining); GMLFN(time_source_get_units);
GMLFN(time_source_get_time_remaining); GMLFN(time_source_get_state);
...
GMLFN(extension_stubfunc_real); GMLFN(extension_stubfunc_string);
...
GMLFN(switch_accounts_select_account); GMLFN(switch_controller_acceleration);
GMLFN(switch_controller_angular_velocity); GMLFN(switch_controller_joycon_left_connected);
GMLFN(switch_controller_joycon_right_connected); GMLFN(switch_controller_set_supported_styles);
...
GMLFN(device_mouse_check_button); GMLFN(device_mouse_check_button_pressed); GMLFN(device_mouse_check_button_released);
GMLFN(device_mouse_dbclick_enable); GMLFN(device_mouse_x); GMLFN(device_mouse_y);
GMLFN(device_mouse_raw_x); GMLFN(device_mouse_raw_y);
GMLFN(device_mouse_x_to_gui); GMLFN(device_mouse_y_to_gui);
GMLFN(display_mouse_get_x); GMLFN(display_mouse_get_y);
...
GMLFN(draw_get_lighting);
GMLFN(draw_light_define_ambient);
GMLFN(draw_light_define_direction);
GMLFN(draw_light_define_point);
GMLFN(draw_light_enable);
GMLFN(draw_light_get);
GMLFN(draw_set_color_write_enable);
GMLFN(draw_set_colour_write_enable);
...
GMLFN(gpu_get_texfilter);
GMLFN(gpu_get_texfilter_ext);
...
GMLFN(d3d_transform_stack_clear);
GMLFN(d3d_transform_stack_discard);
GMLFN(d3d_transform_stack_empty);
GMLFN(d3d_transform_stack_pop);
GMLFN(d3d_transform_stack_push);
GMLFN(d3d_transform_stack_top);
GMLFN(d3d_primitive_begin);
GMLFN(d3d_primitive_begin_texture);
GMLFN(d3d_primitive_end);
GMLFN(d3d_vertex);
GMLFN(d3d_vertex_color);
GMLFN(d3d_vertex_colour);
GMLFN(d3d_vertex_texture);
GMLFN(d3d_vertex_texture_color);
GMLFN(d3d_vertex_texture_colour);
GMLFN(mean);
